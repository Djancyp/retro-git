...
_G.packer_plugins = {
  ...
  ["test_plugin.nvim"] = {
    loaded = true,
    path = "/home/djan/.local/share/nvim/site/pack/packer/start/test_plugin.nvim",
    url = "/home/djan/Desktop/lua/test_plugin.nvim"
  },
  ["vim-bbye"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-colorizer.lua', 'neoscroll.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
