...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-colorizer.lua', 'cinnamon.nvim', 'nvim-treesitter'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'nvim-colorizer.lua', 'cinnamon.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
