...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'FixCursorHold.nvim', 'nvim-colorizer.lua', 'cinnamon.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
