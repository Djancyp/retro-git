...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'cinnamon.nvim', 'nvim-colorizer.lua', 'FixCursorHold.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
