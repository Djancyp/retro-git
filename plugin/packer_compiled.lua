...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'cinnamon.nvim', 'nvim-colorizer.lua', 'nvim-treesitter', 'FixCursorHold.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
