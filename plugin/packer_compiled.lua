...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-treesitter', 'FixCursorHold.nvim', 'cinnamon.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
